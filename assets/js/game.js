...
if (promptFight === "fight" || promptFight === "FIGHT") {
  //remove enemy's health by subtracting the amout set in the playeAttack
  ...
  //Log a resulting message to the conso so we know that it worked.
  console.log(
  ...
  //if no (fales), ask question again by running fight()again
  else {
    fight();
  }
